...
if($_SESSION["Type"]=="Student"){
    if($_SESSION["Status"]==1){
        echo "<script>alert('Already Submitted');location='/~lipe4387/final/StudentPage.php'</script>";
    }else if($_SESSION["Status"]==2){
        echo "<script>alert('Already Checked');location='/~lipe4387/final/StudentPage.php'</script>";
    }
...
<body>
    <nav class="nav">
        <h1>Navagation</h1>
        <ul>
            <li><a href="/~lipe4387/final/Logout.php">Log Out</a></li>
            <?php if($_SESSION["Type"]=="Faculty"){?>
            <li><a href="/~lipe4387/final/FacultyPage.php">Faculty Page</a></li><!-- check when click to see if already completed/continue -->
            <?php }else if($_SESSION["Type"]=="Student"){ ?>
            <li><a href="/~lipe4387/final/StudentPage.php">Student Page</a></li><!-- check when click to see if already completed/continue -->
            <?php } ?>
        </ul>
    </nav>
    <div class="container">
        ...
        <div class="container">
            <form id="form" action="/~lipe4387/final/StudentInsert.php" onsubmit="return validateForm()" method="POST">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <input type="text" class="form-control" id="CUNYFirstID" name="CUNYFirstID">
                ...
                <div class="form-group row">
                    <label class="col-sm-4" for="AddressLine2">Mailing Address Line 2:</label>
                    <div class="col-sm-6">
