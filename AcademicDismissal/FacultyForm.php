...
$res=$row["statusID"];
if($res=="2"){
    echo "<script>alert('Already Checked');location='/~lipe4387/final/FacultyPage.php'</script>";
}
$sql="SELECT USER_ID, SUBMIT_DATE, F_NAME, M_NAME, L_NAME, ADD1, ADD2, EMAIL, H_PHONE, C_PHONE 
FROM FORM  
WHERE USER_ID = '$id';";
...
<body>
    ...
    <div class="container">
        ...
        <div class="container">
            <form id="form" action="/~lipe4387/final/FacultyInsert.php" onsubmit="return validateForm()" method="POST">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                      <input type="date" class="form-control" id="Date" name="DateReviewed">
                    </div>
                </div>
                <div class="form-group row">
